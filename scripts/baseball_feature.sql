...
CREATE OR REPLACE TEMPORARY TABLE home_pitcher_stats as
SELECT
   g.local_date
  ,pc.game_id
  ,pc.team_id
...
CREATE OR REPLACE TEMPORARY TABLE away_pitcher_stats as
SELECT
    g.local_date
  , pc.game_id
  , pc.team_id
...
CREATE OR REPLACE TEMPORARY TABLE all_pitcher_stats AS
SELECT
...
CREATE OR REPLACE TEMPORARY TABLE features_ratio AS
SELECT
       fs.game_id
     , fs.home_team_id
     , fs.away_team_id
